#import "tools/pageframe.typ": page-frame-continuous, page-frame-sequence, page-frame-title
#import "tools/referencing.typ": (
  document-append-defs, document-display-list, document-display-table, document-ref, header-legislation,
  header-reference,
)
